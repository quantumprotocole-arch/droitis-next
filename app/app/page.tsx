...
export default function AppPage() {
  ...
  const [usage, setUsage] = useState<{ top_k?: number; rpcOk?: boolean } | undefined>(
    undefined
  )
  ...
  return (
    <main style={styles.main}>
      ...
      <footer style={styles.footer}>
        <small>
          Front = clé anonyme uniquement. La Service Role Key reste strictement côté serveur (/api/chat).
        </small>
      </footer>
    </main>
  )
